...
int main()
{   // Advancement needed : use calloc malloc and realloc for better memory optimisation.
    char re[50];
    int r;
    ...
    // printf("Booleanv value is %d \n",b);     // if b = false, means all elements in string are same.
